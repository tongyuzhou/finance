...
<!--div meta="现行还款方案情况" style="padding:10px;">  
										...
										<table id="table_" style="width:100%;">
                                            ...
                                            <td id="td_d2">银行账号：</td>
                                            <td id="td_i"><span id="bankAccount" class="repaymentScheme">6228460320002783xxx</span></td>      <td id="td_d2">货款额度：</td>
                                        ...
                                        <tr id="tr_cell">
                                            ...
                                            <td id="td_i"><span id="frequency" class="repaymentScheme">1</span></td>											
												...
												<tr id="tr_cell">
													...
													<td id="td_d2">尚欠月账户服务费：</td>
													<td id="td_i"><span id="oweFee" class='proposalRequests'></span>1,000.00</td>
													<td id="td_d2">尚欠其他费用：</td>
													<td id="td_i"><span></span></td>
												</tr>
												<tr id="tr_cell">
													<td id="td_d2">逾期应还本金：</td>
													<td id="td_i"><span id="overduePrincipal" class='proposalRequests'></span>1,000.00</td>
													<td id="td_d2">逾期应还利息：</td>
													<td id="td_i"><span id="overdueInterest" class='proposalRequests'></span>1,000.00</td>
													<td id="td_d2">逾期应还月账户服务费：</td>
													<td id="td_i"><span id="overdueFee" class='proposalRequests'></span>1,000.00</td>
													<td id="td_d2">现存逾期天数：</td>
													<td id="td_i"><span id="overdueDays" class='proposalRequests'></span></td>
												
		
		<!--div meta="还款明细" style="padding:10px;">  
				<table id="t2" class="easyui-datagrid" style="width:auot;height:auto"  dtoolbar="#toolbar" pagination="true" rownumbers="true"> 
				   <thead>   
						<tr>
								<th field="name1" width="140">还款时间</th>			
								<th field="name2" width="150">还款金额</th>   		
								<th field="name4" width="140">还款银行</th>				
								<th field="name5" width="140">卡、折</th>
								<th field="name6" width="140">还款账号</th>
								<th field="name7" width="140">所属还款日</th>
						</tr>   								
					</thead>  
					<tbody>
						<tr> 
		...
		<!--div meta="分配明细" style="padding:10px;">  
				<table id="t6" class="easyui-datagrid" style="width:auto;height:auto"  dtoolbar="#toolbar" pagination="true" rownumbers="true" >   
				   <thead>   
						<tr>   
								<th field="name1" width="140">还款时间</th>			
								<th field="name2" width="150">所属还款月份</th>   
								<th field="name3" width="150">本金</th>				
								<th field="name4" width="140">利息</th>				
								<th field="name5" width="140">服务费</th>
								<th field="name6" width="140">滞纳金</th>
								<th field="name7" width="140">罚息</th>
								<th field="name8" width="140">合计</th>
						</tr>   		
		...
		<!--div meta="违约明细" style="padding:10px;" >  

                               		<p id="p_">客户基本信息</p>
                                	<table id="table_"  width="100%">
                                        <tbody><tr id="tr_cell">
                                            <td id="td_d2">客户编号：</td>
                                            <td id="td_i"><span id="clientId" class="reductionInformation2">196439</span></td>
                                            <td id="td_d2">客户姓名：</td>
                                            <td id="td_i"><span id="clientName" class="reductionInformation2">客户196439</span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">出生日期：</td>
                                            <td id="td_i"><span id="birthday" class="reductionInformation2"></span></td>
                                            <td id="td_d2">性别：</td>
                                            <td id="td_i"><span id="gender" class="reductionInformation2">女</span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">户籍详细地址：</td>
                                            <td id="td_i" colspan="3"><span id="censusRegister" class="reductionInformation2">浙江省苍南县灵溪xxxxxxxx</span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">身份证号：</td>
                                            <td id="td_i"><span id="idNumber" class="reductionInformation2">330327197706210745</span></td>
                                            <td id="td_d2">证件有效期：</td>
                                            <td id="td_i"><span id="usefulLife" class="reductionInformation2">2026-06-21</span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">婚姻状态：</td>
                                            <td id="td_i"><span id="marital" class="reductionInformation2">未婚</span></td>
                                            <td id="td_d2">有无子女：</td>
                                        ...
                                        <tr id="tr_cell">
                                            ...
                                            <td id="td_d2">信用卡额度：</td>
                                            <td id="td_i"><span id="creditAmount" class="reductionInformation2">0.00</span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">手机号码：</td>
                                            <td id="td_i"><span id="mobilePhone" class="reductionInformation2"></span></td>
                                            <td id="td_d2">邮件编码：</td>
                                            <td id="td_i"><span id="zipCode" class="reductionInformation2"></span></td>
                                        </tr>
                                        <tr id="tr_cell">
                                            <td id="td_d2">本市地址：</td>
                                            <td id="td_i" colspan="3"><span id="address" class="reductionInformation2">浙江省杭州市</span></td>
                                        </tr>
                                    </tbody></table>
                                    <p id="p_">违约记录</p>		
								
												<table id="t3" class="easyui-datagrid" style="width:auto;height:auto"  dtoolbar="#toolbar" pagination="true" rownumbers="true" >   
											   <thead>   
													<tr>   
															<th field="name1" width="140">借款合同编号</th>			  
															<th field="name3" width="150">违约期号</th>				
															<th field="name4" width="140">违约起始日期</th>				
															<th field="name5" width="140">逾期天数</th>
													</tr>   		
...
<option label="国家开发银行" value="41">国家开发银行</option>
		...
		<div meta="修改还款情况" style="padding:10px;">  
				<table id="t6" class="easyui-datagrid"
				style="width:auto;height:auto" dtoolbar="#toolbar" pagination="true"
				rownumbers="true">   
				   <thead>   
						<tr>   
								<th field="name29" width="90" align="center">合同编号</th>
								<th field="name30" width="90" align="center">所属分期</th>
								...
								<th field="name3" width="90" align="center">当月应收利息</th>	
									...
									<th field="name8" width="110">当月应收变更手续费</th>
								
								<th field="name9" width="100">当月应收其他费用</th>
								<th field="name31" width="90" align="center">当月应收款合计</th>
								...
								<th field="name12" width="90">当月实收服务费</th>
									...
									<th field="name16" width="110">当月实收变更手续费</th>
									<th field="name27" width="100">当月实收其他费用</th>
								
								<th field="name32" width="90" align="center">当月实收款合计</th>
								...
								<th field="name20" width="90">当月减免滞纳金</th>
									...
									<th field="name23" width="100">当月减免前期费用</th> 
									<th field="name28" width="100">当月减免其他费用</th>
									<th field="name24" width="80">还款状态</th>
								
                                <th field="name25" width="100">备注</th>
                                <th field="name26" width="100">创建者</th>
								<th field="name33" width="90" align="center">创建时间</th>
								<th field="name34" width="90" align="center">末次修改者</th>
								<th field="name35" width="90" align="center">末次修改时间</th>
								
									<th field="name36" width="90" align="center">是否处理中</th>
									<th field="name37" width="90" align="center">修改类型</th>
					...
					<tbody>
						...
						<tr> 
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="123456"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2010-11-03"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="360.00"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="1,666.67"></td>
							
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="432.00"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="360.00"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="45.00"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="3.15"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="3.15"></td>
							
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2,461.82"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="360.00"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="1,666.67"></td>
							...
							style="vertical-align:middle" value="432.00"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="0.00"></td>
							...
							style="vertical-align:middle" value="1,666.67"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="还款中"></td>
							
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="无"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="张"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2010-11-03"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="王"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2010-11-03"></td>
							
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="否"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="0"></td>
						...
						<tr>
							...
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="2,458.67"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="360.00"></td>
							<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="1,666.67"></td>
							...
							style="vertical-align:middle" value="0.00"></td>
								<td><input id="idNumber" name="idNumber"
							style="vertical-align:middle" value="4,920.49"></td>
					...
					<tr>
	                    <td>
	                    	<span id="submit_right">
		                    	<a id="submit" href="#"
								class="easyui-linkbutton l-btn" onClick="commitDeratePayment();"
								group="">保存</a>
		                        &nbsp;
								<a id="submit" href="#" class="easyui-linkbutton l-btn"
								onClick="commitDeratePayment();" group="">重置</a>
								&nbsp;
		                        <a id="backButten"
			...
			<p id="p_"></p>
						   ...
						   <tr id="tr_cell">
								...
								<td width="75%">  
									<input type="text" id="repaymentStart"
							style="width: 160px; display: none;" class="easyui-datetimebox"
							value="" comboname="repaymentStart">
